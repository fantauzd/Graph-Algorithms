...
# Given a graph, find the minimum set of vertices that cover all the edges of the graph.

# One possible approach to solve this problem will be to pick a random edge E that has vertices (u,v).
# Add these vertices to the solution set. Remove all edges that are connected to either u,v.
